    ...
    <div class="d-flex bg-light" id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid mt-4 px-4">
                <header class="mb-5">
                    <?php
                    $getteacher = executeNonQuery($connect, "SELECT * from members where member_id = '$id'");
                    $result = fetchAssoc($connect, $getteacher);
                    $teacher = $result['member_salut'] . ' ' . $result['member_last'];
                    ?>
                    <h1>Schedule for you <?php echo $teacher ?></h1>
                </header>
                <main>
                    <div class="row mb-5">
                        <div class="col-6">
                    ...
                    <div id="conttable">
                        <table class="table d-none table-striped w-auto" id="tableteacher">
                            <p class="d-none text-bold text-dark" id="specificschedteacher"><span id="assignedteacher"></span></p>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#schoolyear').change(function() {
                ...
                $("span[id^='assigned']").html(`Schedule for <?php echo $teacher ?> on ${semfixed} of ${schoolyear} school year.`);
                $.getJSON(`../queries/getsched.php?getteacher=${teacherid}&schoolyear=${schoolyear}&semester=${semester}`, function(data) {
                    if (data.length === 0) {
                        ...
                        if (trlength === 0) {
                            ...
                            let schedrow = '';
                            $('#specificschedteacher').removeClass('d-none');
                            $('#tableteacher').removeClass('d-none');
        ...
        function Popup(data, data2) {
            ...
            *{
            ...
            #table td, #table th {
                border: 1px solid black !important;
                padding: 5px 0.5rem 0.5rem 5px !important;
            }
            </style>`);
