...
<body>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid mt-4 px-4">
                <div class="row">
                    ...
                    <table class="table table-striped" id="facultyPendingTable">
                        <!-- kuhaon tanan mga processing na mga schedules dapat -->
                        <thead class="table-dark">
                            <tr>
                                <th class="text-center d-none">Conflict</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr id="tbodyrow_<?php echo $i ?>" <?php echo $rows['conflict_status'] === 'conflicted' ? 'style="background:red;"' : '' ?>>
                                        ...
                                        <td class="text-center"><button class="btn btn-sm btn-success" onclick="approve(<?php echo $rows['schedule_id'] ?>, <?php echo $i ?>, <?php echo $rows['assigner'] ?>);"><i class="fa-solid fa-check"></i></button></td>
                                        <td class="text-center"><button class="btn btn-sm btn-danger" onclick="disapprove(<?php echo $rows['schedule_id'] ?>, <?php echo $i ?>, <?php echo $rows['assigner'] ?>);"><i class="fas fa-thumbs-down"></i></button></td>
                                    </tr>
                                <?php
                                } else {
    ...
    <script>
        ...
        function approve(schedid, rowid, proposer) {
            assigner = proposer;
            // alert(assigner);
            Swal.fire({
                        ...
                        if (maestradb === maestra) {
                            if ((data[i].course === klasehanan) || data[i].course != klasehanan) {
                                if (starttimedb === start && endtimedb === end) {
                                    document.location.href = `../functions/schedsprocessing.php?conflictedfaculty=${schedid}`;
                                    return;
        ...
        function disapprove(schedid, row, proposer) {
            assigner = proposer;
            Swal.fire({
                title: 'Are you sure?',
        ...
        $(document).ready(function() {
            // let table = new DataTable('#facultyPendingTable');
